...
interface OpeningPromptInputEnhanced {
  ep1Full: string
  ep2Full: string
  ep3Full: string
  ep1Head: string
...
interface PaywallHooksPromptInput {
  // 第一付费点
...
interface StoryPromptInputEnhanced {
  ep1Sample: string
  epMidSample: string
  epEndSample: string
...
interface MarketPotentialPromptInput {
  // 市场维度输入
...
export type {
  MarketPotentialPromptInput,
  OpeningPromptInputEnhanced,
  PaywallHooksPromptInput,
  StoryPromptInputEnhanced,
}
